...
namespace LocadoraVeiculos.Tests.LocacaoModule
{
    ...
    public class LocacaoTest
    {
        ...
        {
            // arrange
            Cliente cliente = new Cliente("Tiago Santini", "tiago@gmail.com","Maria de Melo Kuster", "(49) 9805-6251", "CPF", "123123124", new DateTime(2025, 06, 30), "41421412412", "41242121412", null);
