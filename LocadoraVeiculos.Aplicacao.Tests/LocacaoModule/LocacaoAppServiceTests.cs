...
namespace LocadoraVeiculos.Aplicacao.Tests.LocacaoModule
{
    ...
    public class LocacaoAppServiceTests
    {
        ...
        //    Mock<ILocacaoRepository> locacaoDaoMock = new Mock<ILocacaoRepository>();
        //    Mock<ITaxasServicosRepository> taxaDaoMock = new Mock<ITaxasServicosRepository>();
        ...
        //    LocacaoAppService locacaoService = new LocacaoAppService(locacaoDaoMock.Object, taxaDaoMock.Object,
        //        Mock.Of<IGeradorRecibo>(), Mock.Of<INotificadorEmail>(), verificadorConexaoInternetMock.Object);
